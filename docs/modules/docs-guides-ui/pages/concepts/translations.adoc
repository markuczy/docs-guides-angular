...
A {onecx_compatible_application}[OneCX compatible application] can be set up for multi-language translation to support multiple languages in the application, using the `@ngx-translate` library.
