...
[#react-synced-router]
=== Syncing Location with the Shell

`@onecx/react-webcomponents` also provides routing integration helpers that keep the shell aware of the app's current location:
