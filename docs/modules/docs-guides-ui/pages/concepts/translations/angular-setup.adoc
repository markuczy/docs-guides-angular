...
= Translations Setup in Angular Applications

A {onecx_compatible_application}[OneCX compatible application] can be set up for multi-language translation to support multiple languages in the application, using the `@ngx-translate` library. This page covers the setup steps. See xref:documentation:docs-guides-ui:concepts/translations/angular-usage.adoc[Translations Usage in Angular Applications] for how to use translations once set up.
